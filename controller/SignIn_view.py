...
class IniciarSesionView(object):
    def __init__(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(-10, -10, 1021, 681))
        self.label.setStyleSheet("border-image: url(:/resources/fondo.jpg);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:72pt; color:#d8d8d8;\">InfoPlaces</span></p></body></html>"))
