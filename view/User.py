...
class UserProfileView(object):
    def __init__(self, MainWindow, user):
        ...
        self.Potho.setGeometry(QtCore.QRect(40, 170, 241, 211))
...
"color: rgb(255, 255, 255)")
        ...
        self.Email.setGeometry(QtCore.QRect(310, 330, 101, 31))
        font = QtGui.QFont()
        font.setPointSize(17)
...
"color: rgb(225,225,225)")
        ...
        self.pushButton_back_Change_Password.setGeometry(QtCore.QRect(240, 390, 250, 31))
        font = QtGui.QFont()
        font.setPointSize(15)
